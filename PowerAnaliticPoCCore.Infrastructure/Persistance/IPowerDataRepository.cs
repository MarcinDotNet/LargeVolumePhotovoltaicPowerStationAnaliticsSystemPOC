...
namespace PowerAnaliticPoCCore.Infrastructure.Persistance;
...
public interface IPowerDataRepository
{
    ...
    /// <param name="to"></param>
    /// <returns></returns>
    Task<IEnumerable<PowerGeneratorTimeRangeData>> GetPowerGeneratorTimeRangeDataAsync(int generatorId,
    ...
    /// <param name="to"></param>
    /// <returns></returns>
    Task<IEnumerable<PowerGeneratorTimeRangeData>> GetPowerGeneratorTimeRangeDataAsync(TimeRange timeRange,
    ...
    /// </summary>
    /// <param name="data"></param>
    Task<IEnumerable<PowerGeneratorDetailData>> GetPowerGeneratorDataBelowExpectedCurrentAsync(DateTime from,
        DateTime to);
